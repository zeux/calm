...
huggingface_hub.snapshot_download(repo_id=args.repo, local_dir=args.output, local_dir_use_symlinks=False, resume_download=True, ignore_patterns=["*.bin", "*.pth", "*.pt"])
